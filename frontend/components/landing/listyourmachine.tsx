...
const benefits = [
  {
    ...
    description:
      "Every day your equipment sits unused is money lost. List it and turn downtime into income.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Set your own rates, mark availability, and talk to renters directly. No commission taken from you.",
    icon: (
  ...
  {
    title: "Reach contractors nearby",
    description:
      "Get discovered by builders actively searching for your machine type in your area — right when they need it.",
    icon: (
...
export default function ListYourMachine() {
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-28">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 bottom-0 h-96 w-96 rounded-full bg-hivis/10 blur-3xl"
      />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-5 max-w-lg text-lg leading-relaxed text-neutral-600">
              List your excavator, mixer, pump, or loader on ACE and connect
              with contractors who need it. Free to list, and you keep every
              rupee you earn.
            </p>
            ...
            <p className="mt-6 flex items-center gap-2 text-sm text-neutral-500">
              ...
              No listing fee · No commission · Set up in minutes
            </p>
          </div>
