...
const steps = [
  {
    ...
    description:
      "Filter by machine type and location to instantly see every available machine near your site.",
    icon: (
  ...
  {
    number: "02",
    title: "Compare rates & availability",
    description:
      "See live daily rates, current availability, and owner details side by side — no hidden markups.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Call or message the owner straight away to arrange your rental. No middlemen, no commission.",
    icon: (
...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative scroll-mt-20 bg-mist py-20 sm:py-28"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-lg leading-relaxed text-neutral-600">
            No calls to dozens of dealers. No guesswork on pricing. Find what
            you need and book it the same day.
          </p>
        </div>
